package com.tudodebom.clientes;


import com.tudodebom.cliente.model.bean.Dados;
import com.tudodebom.cliente.model.dao.ClienteDAO;
...
public class Clientes extends javax.swing.JFrame {
    ...
    public void lerTabela(){
        ...
        for(Dados dado: dao.voltarDados()){
    ...
    public void lerTabelaBusca(String nome){
        DefaultTableModel modelo = (DefaultTableModel) tabelaClientes.getModel();
        modelo.setNumRows(0);
        ClienteDAO dao = new ClienteDAO();
        
        for(Dados dado: dao.buscaDados(nome)){
            modelo.addRow(new Object[]{
            dado.getId(),
            dado.getNome(),
            dado.getCPF(),
